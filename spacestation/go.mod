module github.com/Liphium/station/spacestation
...
require (
	...
	github.com/Liphium/station/pipeshandler v0.0.0-20240819105432-c6d7be0605b2
...
require (
	...
	github.com/Liphium/station/chatserver v0.0.0-20240819105432-c6d7be0605b2 // indirect
