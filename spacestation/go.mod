...
require (
	...
	github.com/Liphium/station/pipeshandler v0.0.0-20250116162322-137676363896
...
require (
	github.com/Liphium/station/chatserver v0.0.0-20250116162322-137676363896 // indirect
