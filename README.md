...
Welcome to everything powering the magic experience you get in the [Liphium app](https://github.com/Liphium/chat_interface). Station powers all of Liphium's features and is it's backbone. Just as a quick note, we call all servers running station "town", because that makes explaining decentralization a lot easier. If you here "town", you can assume we mean a server running station. If you want to know more about how Liphium works, take a look at our [documents folder](https://drive.proton.me/urls/THTQTVHB6C#YHseoQ4FPb9i).
